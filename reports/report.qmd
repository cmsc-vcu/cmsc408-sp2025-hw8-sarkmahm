...
GITHUB URL:  <https://github.com/cmsc-vcu/cmsc408-sp2025-hw8-sarkmahm>


# Problem Background

Our goal for the home work is to analyze data using SQL from WDI Database
...
from sp25_sarkermm_user.wdi_country
...
execute_ddl(cnx,"""
start transaction;
UPDATE sp25_sarkermm_user.wdi_country
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM sp25_sarkermm_user.wdi_country AS original
    WHERE 
        original.`Region` = regions.region 
...
I feel most confident using basic SELECT, WHERE, GROUP BY, and aggregate functions. I still need more practice with complex joins and subqueries. This assignment helped me better understand how to structure queries and use SQL to explore data meaningfully.

2. Problem-Solving Approach: Describe your approach to tackling the more complex tasks (like Tasks 18, 23, and 24). How did you break down these problems, and what steps did you take when you encountered challenges? How would you approach a similar problem differently in the future?

For harder tasks, I broke the problems into smaller parts—first understanding what the question was asking, then testing small queries step by step. When stuck, I looked back at earlier tasks or simplified the logic. In the future, I’ll plan out more with comments and use temporary queries to test ideas.


3. Learning Takeaways: Consider the overall learning experience from this assignment. What were the biggest takeaways about working with SQL for data analysis and transformation? How do you think these skills will apply in real-world scenarios or future coursework?

I learned how powerful SQL is for analyzing and transforming data. Working with real-world data like the World Bank dataset made it more practical. These skills will definitely help in future courses and any job that involves data analysis.
